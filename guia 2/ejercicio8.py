...
cantv=int(input("Introduzca la cantidad de unidades vendidas (para cancelar, introduzca un numero negativo): "))
while cantv>=0:
...
print(f"\nEl total de ventas diferentes ingresadas es de: {ventas}")
